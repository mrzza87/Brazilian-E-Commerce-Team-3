...
# Creation Date/Time: 2025-06-16 11:20:19.733781
...
def build_expectations_gxe_09_olist_fact_sales_suite(suite):
  ...
  suite.add_expectation(exp)
  exp = gx.expectations.ExpectColumnValuesToBeInSet(column="order_status", value_set=['approved','canceled','created', 'delivered', 'invoiced','processing','shipped','unavailable'], mostly="0.9")
  suite.add_expectation(exp)
