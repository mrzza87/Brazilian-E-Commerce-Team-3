# File Name: gxe_01_olist_customers_suite.py
# Creation Date/Time: 2025-06-14 17:18:47.936237

# Usage:
#        from gx_exp_gxe_01_olist_customers_suite import build_expectations_gxe_01_olist_customers_suite
#        suite = build_expectations_gxe_01_olist_customers_suite(suite)

import great_expectations as gx

def build_expectations_gxe_01_olist_customers_suite(suite):
