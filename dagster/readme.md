...
Even though no changes are required, test and debug this GX validation before going to the next stage.
  ```bash
bash
...
### 5) GX Dim & Fact Tables Validation.
The script for GX does not validate the dim table that you had created above.
